...
func TestMediaService_ScanFolderFirstScan(t *testing.T) {
	...
	result, err := svc.scanFolderInternal(folder.ID, nil)
	if err != nil {
...
func TestMediaService_ScanFolderNoChange(t *testing.T) {
	...
	svc.scanFolderInternal(folder.ID, nil)
...
func TestMediaService_ScanAllFolders(t *testing.T) {
	...
	for _, f := range folders {
		result, err := svc.scanFolderInternal(f.ID, nil)
		if err != nil {
...
func TestMediaService_FullWorkflow(t *testing.T) {
	...
	// 2. First scan
	scanResult, err := svc.scanFolderInternal(folder.ID, nil)
	if err != nil {
		t.Fatalf("scanFolderInternal: %v", err)
	}
	...
	rescan, err := svc.scanFolderInternal(folder.ID, nil)
	if err != nil {
